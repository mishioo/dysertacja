...
Redukcji przy użyciu \ch{LiAlH4} jest dzisiaj chyba najbardziej sztandarowym przykładem reaktywności amidów.
...
Przedstawili oni metodę syntezy \iupac{\a-chloroenamin} z~amidów przy użyciu fosgenu i zasady (trietyloaminy lub pirydyny)\autocite{ghosez69}.
...
\begin{figure*}
  \centering
  \includegraphics{graphics/timeline2}
  \caption{Istotne wydarzenia w historii w konekście aktywacji amidów.}
  \label{fig:timeline}
\end{figure*}
