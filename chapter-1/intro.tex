...
\begin{marginfigure}[7\baselineskip]
  \includesvg[intro/]{glutathione}  % TODO: number glutathione
  \caption{
...
\begin{marginfigure}
  \includesvg[intro/]{lidocaine}  % TODO: number lidocaine
  \caption{
...
Obecnie, ze względu na bezpieczeństwo oraz wygodę eksperymentatora, do przeprowadzenia
  ...
  % TODO: n-bromo sukcyno imid to n-bromo imid kwasu bursztynowego
...
Chemia amidów była więc raczej uboga, a~wykorzystanie wiązania amidowego w~syntezie
  często sprowadzało się do jego obecności w~produktach.  % TODO: i ??
