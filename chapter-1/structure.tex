...
Naukowcy badali przyczynę występowania bariery rotacji wokół wiązania \ch{C-N} w~ugrupowaniu
  amidowym, która wynosi ok. \SI{18}{\kcalpm} w~przypadku formamidu\sidecite[-6\baselineskip]{schneider60}.
Sporo kontrowersji wzbudziła praca Wiberga~i~in.\sidecite[-4\baselineskip]{wiberg87},
...
Inne metody analizy ładunku nie potwierdziły tego twierdzenia\sidecite[-1\baselineskip]{wiberg92a}.
...
Następne prace, uwzględniające zaktualizowaną teorię rezonansu chemicznego\sidecite[-3\baselineskip]{lauvergnat97},
  teorię wiązań walencyjnych\sidecite[-1\baselineskip]{glendening97}, a~także analizę ładunków atomowych
