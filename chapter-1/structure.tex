...
Na~przykładzie amidu wyjaśnia jak określić co może, a~co nie może być uznane za~strukturę
  ...
  wynoszącą \SI{21}{\kcalpm}\sidecite[-7.5em][str.~192\==197]{pauling60}.
  
A~jednak ta sprawa przez długi czas była kwestią sporną wśród chemików.
Sporo kontrowersji wzbudziła praca Wiberga~i~in.\sidecite[-7.5em]{wiberg87},
  podważająca słuszność modelu rezonansowego.
W~oparciu o~teorię atomów w~cząsteczkach\sidenote[][-6em]{
...
Inne metody analizy ładunku nie potwierdziły tego twierdzenia\sidecite[-3em]{wiberg92a}.
...
Jak pisze w~swoim eseju\sidecite{woodward80}, wydawać się może, że struktura podstawników
  ...
  diastereoizomeru~\refcmpd{thienamycin-S}, widocznych na~\cref{fig:penems}.
Podobną zależność \citeauthor{woodward80} dostrzegł w~przypadku analogicznych
  penemów~\refcmpd{penem-r, penem-s}.
\begin{figure}
  \includesvg{penems}
  \caption{
    Pary diastereoizomerycznych penemów, na~które uwagę zwrócił \citeauthor{woodward80}.
