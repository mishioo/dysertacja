...
Zagorzałą dyskusję wzbudziła praca Wiberga~i~in.\sidecite{wiberg87},
  podważająca słuszność modelu rezonansowego.
W~oparciu o~teorię atomów w~cząsteczkach\sidenote{
  ...
  Badera zasugerowali, że rozkład elektronów w~obrębie wiązania amidowego jest inny, niż
  wynikałoby z~dużego udziału dwujonowej struktury rezonansowej.
...
\begin{marginscheme}
  ...
  \label{sch:rotation}
\end{marginscheme}
Zarzutem wobec teorii o~rezonansie pozostawała niejednakowa zmiana długości wiązań \ch{C=O}
...
Alternatywną teorią, tłumaczącą te rozbieżności, był model według którego jedynym wkładem
  ...
  a~stabilizacja wiązania \ch{C-N} następuje poprzez przesunięcie pary elektronowej
  z~atomu azotu w~kierunku dodatnio naładowanego atomu węgla\sidecite{wiberg92b}.

Model polaryzacyjny spotkał się z~bardzo mieszanym przyjęciem i~wywołał lawinę publikacji
