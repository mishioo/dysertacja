...
\citeauthor{hill06a} zaadaptowali metodę Ghoseza do syntezy pochodnych pirydyny z~\iupac{\N-winylowych}\footnote{
...
Pierwsza zaproponowana przez nich procedura była dwuetapowa \--- najpierw funkjonalizowali amid acetylenkiem miedzi,
  żeby następnie przeprowadzić cyklizację katalizowaną kompleksem rodu\autocite{hill06a, hill07syn}.
Później odkryli, że bogate w~elektrony alkeny i~enole sililowe są wystarczająco nukleofilowe, by wchodzić w~reakcję z~triflanami \iupac{1-pirydyloimidoilu},
  bez konieczności generowania związków miedzioorganicznych.
Addycja takich alkenów czy enoli prowadzi do powstania wysoce reaktywnych intermediatów.
Ulegają one samoczynnej cyklizacji i~aromatyzacji, tworząc od razu pochodne pirydyny \--- w~jednym kroku syntetycznym\autocite{hill07}.
W~analogicznym procesie, wykorzystując nitryle w~roli nukleofila, można otrzymać pochodne pirymidyny\autocite{hill06b}.
...
Autorzy nie wdają się w~dyskusję nad przyczyną konieczności stosowania słabszej zasady,
  ale pokazali, że stosowanie innych zasad prowadzi do znacznie niższych wydajności\autocite{hill06b}.
