...
Przemiany te pozwalają otrzymać odpowiednio \iupac{1,2-diaminy} i~\iupac{1,2-aminoalkohole}\autocite{huang15comm}.
Tę samą metodę generowania imin wykorzystano do przeprowadzenia wieloskładnikowej reakcji Ugiego\autocite{zheng15}.
W~standardowej wersji tej reakcji imina generowana jest również \latin{in situ}, ale w~wyniku kondensacji aminy i~ketonu\todo{cytowanie}.
...
\todo{czy dodać trifluorometylowanie \textbf{chen18}, dialkinowanie \textbf{chen19joc}, geminalne cyanjanowanie-fosforylacja \textbf{chen19}}
...
Polega ona na~hydrosililowaniu aktywowanego amidu za~pomocą \ch{Et3SiH}, co prowadzi do powstania iminy.
