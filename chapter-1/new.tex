...
\ch{NaH} jest silną zasadą, ale \--- mimo obecności anionu wodorkowego \--- nie jest raczej
  wykorzystywany w~tej roli.
Można wymienić po~temu kilka przyczyn, począwszy od~jego nierozpuszczalności w~mediach
  ...
  antywiążącym grupy karbonylowej\sidecite{furman2020}.
Niezwykle istotnym czynnikiem jest też zwięzłość i~regularność sieci krystalicznej \ch{NaH}.
Badaczom udało się wpłynąć na~ten ostatni aspekt dzięki dodatkowi \{NaI} \--- wprowadzenie
  atomów jodu do~struktury pozwoliło na~\enquote{odsłonięcie} części anionów
  wodorkowych\sidecite{hong16}.

% rysunek ze strukturą krystaliczną
% redukcja, aktywacja Grigniardem i cyjanowanie
% selektywność metody
% schemat nah-nai-activation