...
Dość zaskakująca, i~przez to niezwykle interesująca, jest najnowsza metoda aktywacji,
  zaproponowana przez Chibę, Dixona i~in., wykorzystująca wodorek sodu jako reduktor.
\ch{NaH} jest silną zasadą, ale \--- mimo obecności anionu wodorkowego \--- nie jest raczej
  wykorzystywany jako reduktor.
Można wymienić po~temu kilka przyczyn, począwszy od~jego nierozpuszczalności w~mediach
  organicznych, po~mały rozmiar jego orbitalu 1s, utrudniający nakładanie się z~orbitalem
