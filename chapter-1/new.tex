% TODO: move catalysts on top of reaction arrow on schemes
...
Zaproponowali też mechanizm tej redukcji i~dowiedli dobrej chemoselektywności kompleksu
  van~der~Enta\sidenote{%
    W~literaturze zwykle wspominany jest przy użyciu wzoru sumarycznego,
      rzadko występuje pod nazwiskiem odkrywcy: \colorcite{ent73}.
  } względem amidów.
...
Chida i~Sato niezależnie prowadzili badania na~tym samym polu i~zaproponowali bardzo podobne
  warunki, z~tym, że używając~\ch{Yb(OTf)3} w~roli kwasu Lewisa\sidecite{takahashi18}.
...
W~wyniku dalszych badań dowiedli, że można zamiast tego przeprowadzić jego funkcjonalizację,
  ...
  Streckera~\refcmpd{cyano-amine-piperidine}\sidecite[-2em]{trillo18}.
\begin{scheme}
