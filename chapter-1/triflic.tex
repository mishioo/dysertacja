...
W~tym drugim przypadku, jeśli w~związku występuje proton w~pozycji \textalpha{} względem grupy karbonylowej, jak w~przypadku \refcmpd{w:bh-amide-tert},
  dochodzi do przesunięcia wiązania podwójnego w~tę pozycję, skutkując powstaniem produktu~\refcmpd{w:bh-piridinium-tert}.
...
\end{marginscheme}
Przejściowe pochodne pirydyniowe \refcmpd{w:bh-piridinium-tert, w:piridinium-sec, w:piridinium-tert}
...
W~rezultacie otrzymali rozmaite \textbeta-aminoestry \refcmpd{w:b-amino-esther},
  które można łatwo przekształcić w~nienaturalne \textbeta-aminokwasy\sidecite{belanger15}.
...
Te pierwsze eksperymenty badaczy z~grupy Huanga obejmowały aktywację jedynie amidów trzeciorzędowych,
  jednak niebawem udowodnili oni, że i~drugorzędowe amidy \refcmpd{w:amide-sec} ulegają takim przemianom.
...
Funkcja ta, jako bioizoster\footnote{%
    Więcej o~bioizosteryzmie, choć w~kontekście tetrazoli, można znaleźć w~rozdziale \secref{synthesis:sugars:bioisosterizm}.%
...
\citeauthor{xiang10} stwierdzili, że można w~ten sposób prowadzić redukcję amidów drugo- jak i trzeciorzędowych,
  ...
  przy jej zastosowaniu\sidecite[-11\baselineskip]{xiang10}.
...
Na podstawie zakresu przykładów przedstawionych w~cytowanej pracy można jednak wnioskować,
  że metoda ta jest ograniczona do liniowych amidów drugorzędowych\sidenote[][-1\baselineskip]{%
    ...
    Więcej o~nich opowiem w~dalszej części tej pracy.
  }.
\begin{scheme}
  \centering
