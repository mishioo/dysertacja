...
\citeauthor{xiang10} stwierdzili, że można w~ten sposób prowadzić redukcję amidów drugo- jak i trzeciorzędowych,
  ale selektywność metody nie jest idealna \--- estry również są przy jej zastosowaniu redukowane\sidecite[-10\baselineskip]{xiang10}.

Lepsze wyniki osiągnęli \citeauthor{huang16b} kiedy udało im się połączyć\sidecite[-9.5\baselineskip]{huang16b} opracowaną dotąd metodologię 
...
Pierwszym z~takich przypadków była cyklizacja związku \refcmpd{w:nuno-claisen-substrate},
  zawierającego fragment eteru allilowego, której przebieg pokazuję na~\cref{sch:maulide-claisen}\sidecite[-2\baselineskip]{madelaine10}.
...
\begin{scheme}
  ...
  \caption{
    Zaproponowana przez \citeauthor{spinozzi19} metoda otrzymywania bicyklicznych soli alkoksyoksazoliniowych
...
\todo[inline]{
  dodać przegrupowania od Maulide \\
