...
Warto może przypomnieć, że drugorzędowe amidy ulegają rozpadowi do~imin samoistnie\sidenote{%
  Choć niektóre źródła \--- na~przykład opisywana właśnie praca \---
    sugerują, że pod wpływem dodatkowej cząsteczki \schwartz{}.%
...
Fakt, że zredukowany odczynnikiem Schwartza trzeciorzędowy amid może zostać przekształcony
  w~kation iminiowy\sidenote{Patrz: \cref{sch:amide-tert-zr-reduction}, str.~\pageref{sch:amide-tert-zr-reduction}},
