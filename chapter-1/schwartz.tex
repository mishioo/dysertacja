...
W~jej wyniku powstają hemiaminal~\refcmpd{nboc-hemiaminal} oraz inne produkty
  redukcji\sidecite{piperno11}, pokazane na~\cref{sch:lactams-reduction-zr}.
...
Należy zaznaczyć, że przemiana ta jest specyficzna dla \iupac{\N-alkoksykarbonylowych} laktamów \---
  w~przypadku \iupac{\N-\H-} oraz \iupac{\N-metylo-\g-laktonu} nie zachodzi,
  a~\iupac{\N-benzoilo-\g-lakton} ulega w~jej warunkach debenzoilowaniu.
\begin{scheme}
  \includesvg[schwartz/]{lactams-reduction-zr}
  \caption{
...
W~przeciwieństwie do~\iupac{\N-alkilohydantoin}~\refcmpd{nh-hydantoin}
  ...
  jedynym produktem reakcji \iupac{\N-\gls{Boc}-hydantoiny} z~\schwartz{} jest  % TODO: number
  związek hydroksylowy~\refcmpd{nboc-hydantoin-zr}.
Wynik ten jest zgodny z~opisanymi powyżej doniesieniami o~redukcji
  \iupac{\N-Boc-}lakatamów~\refcmpd{nboc-lactam}.
\begin{marginscheme}
