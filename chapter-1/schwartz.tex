...
Przykładami takich modyfikacji mogą być pochodna z~pentametylowanym ligandem
  \ch{[(Cp^*)2Zr(H)Cl]}\sidecite[-7\baselineskip]{barger84} czy pochodna triflowa
...
Częściowa redukcja do~formamidu może zostać przeprowadzona dzięki wykorzystaniu łagodniejszego
  \ch{NaBH4}\sidecite[-4\baselineskip]{stecko16}, ale metoda ta nie toleruje wielu grup funkcyjnych.
...
W~oparciu o~wcześniejsze prace zespołów Ganema\sidecite{schedler96} i~Georg\sidecite{white00}
...
% TODO: Wiązania amidowe w pierścieniach - was it really bad?
...
\begin{scheme*}
  % TODO: grzanie -> ogrzewanie - is it necessary?
...
Bariera aktywacji tego procesu w~znacznej mierze zależy od~charakteru podstawnika
  ...
  i~\iupac{\N-karbamylowych}\sidecite[-1\baselineskip]{lanza13}.
...
Jest to dogodna metoda syntezy polihydroksylowanych chinolizydyn i~indolizydyn\sidenote{%
...
W~jednej z~ostatnich prac\sidecite{czerwinski19} zespołu \citeauthor{czerwinski19} przywołują
