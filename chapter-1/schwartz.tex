...
Obserwacja ta stała się podstawą badań nad hydrocyrkonowaniem cyjanofosfin
  ...
  \sidecite{maraval01a, maraval01b, maraval03}
...
Warto zwrócić uwagę, że redukcja ta biegnie w~obecności karbonylu z~grupy
  \iupac{\tert-butoxykarbonylowej} (\acrshort{Boc}), którą zabezpieczona została amina.
...
Przykłady takich przekształceń, wykorzystujące różne nukleofile,
  przedstawiam na~\cref{sch:nitrile-reduction-mcr}.
\begin{scheme}
