...
Wynik tej przemiany zależy od użytego czynnika allilującego, w~przypadku allilopinakoloboranu
  autorzy wydzielili wyłącznie alkohol zamiast oczekiwanej aminy.  % TODO: add scheme/figure
...
Ich reaktywność okazała się zbliżona do~wykazywanej przez amidy trzeciorzędowe,
...
Podejście to zostało zaadaptowane w~syntezie totalnej związków naturalnych,
  na~przykład $(\pm)$\-/gefirotoksyny, \refcmpd{gephiro} na~\cref{sch:gephirotoxin}.
\begin{scheme}
  \includesvg[schwartz/]{gephirotoxin}
  \caption{
    Fragment syntezy totalnej $(\pm)$\-/gefirotoksyny \refcmpd{gephiro},
    wykorzystującej reduktywną funkcjonalizację amidu \refcmpd{gephiro-substrate}
  }
  \label{sch:gephirotoxin}
\end{scheme}
