...
\begin{scheme}
  ...
  \caption{
    W~przeciwieństwie do~amidów drugorzędowych~\refcmpd{w:amide-sec}, wiązanie \ch{C-OZr} nie ulega
    samoczynnemu rozpadowi, być może z~tego powodu \citeauthor{schedler93} nie zaobserwowali
    redukcji amidów trzeciorzędowych~\refcmpd{w:amide-tert}.
  }
