...
Należy zaznaczyć, że przemiana ta jest specyficzna dla \iupac{\N-alkoksykarbonylowych} laktamów \---
  w~przypadku \iupac{\N-\H-} oraz \iupac{\N-metylo-\g-laktamu} nie zachodzi,  % TODO: maybe add comment that it can reduced with different conditions
...
\begin{scheme}
  \includesvg[schwartz/]{zr-deoxygenation}
  \caption{
