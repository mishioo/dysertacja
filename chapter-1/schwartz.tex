...
Jest to dogodna metoda syntezy polihydroksylowanych chinolizydyn i~indolizydyn\sidenote{%
  ...
  }, układów obecnych w~znacznej liczbie biologicznie aktywnych iminiocukrów\sidecite{horne14}.
...
\begin{scheme}
  ...
  \caption{
    ...
    Proces biegnie diastereoselektywnie, ale na~kierunek addycji
      może wpływać struktura zarówno substratu, jak i~nukleofila (\protect\see{sch:gal-allyl}).
  }
...
\begin{scheme}
  ...
  \caption{
    Regiospecyficzna synteza \iupac{2,3-podstawionych} indoli~\refcmpd{2-3-indole}
      z~izatyn~\refcmpd{isatin}, wykorzystująca różnice w~charakterze grup karbonylowych.
  }
  \label{sch:isatins}
\end{scheme}
