...
Ważnym jest też, że metoda nie jest ograniczona jedynie do~allilowania aktywnego kompleksu
...
\Cref{sch:zr-ncac-add} obrazuje, że reakcja reduktywnej addycji izocyjanoacetatów
  ...
  \refcmpd{w:amide-tert} skutkuje powstaniem pochodnych \iupac{5-metoksyoksoazoli}
...
Czytelnika zainteresowanego szczegółami odsyłam do~źródła\sidecite{zheng17}.
\begin{marginscheme}
