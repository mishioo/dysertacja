...
\begin{scheme}
  \includesvg[schwartz/]{amide-reduction-zr}
  \caption{
...
\begin{marginscheme}
  \includesvg[schwartz/]{schwartz-bpin}
  \caption{
...
Inne prace, opisane w~kolejnych akapitach niniejszej dysertacji, pokazały jeszcze więcej 
  możliwości.
\begin{scheme}
  \includesvg[schwartz/]{gephyrotoxin}
  \caption{
...
\begin{scheme}
  \includesvg[schwartz/]{phosphonation}
  \caption{
...
\begin{marginscheme}
  \includesvg[schwartz/]{nitrones-zr}
  \caption{
...
\begin{marginscheme}[-27\baselineskip]
  \includesvg[schwartz/]{zr-ncac-add}
  \caption{
...
Należy zaznaczyć, że przemiana ta jest specyficzna dla \iupac{\N-alkoksykarbonylowych} laktamów \---
  w~przypadku \iupac{\N-\H-} oraz \iupac{\N-metylo-\g-laktonu} nie zachodzi,  % TODO: maybe add comment that it can reduced with different conditions
  a~\iupac{\N-benzoilo-\g-lakton} ulega w~jej warunkach debenzoilowaniu.
\begin{scheme}
  \includesvg[schwartz/]{nboc-lactams-reduction-zr}
  \caption{
...
\begin{marginscheme}
  \includesvg[schwartz/]{hydantoine-reduction-zr}
  \caption{
...
\end{marginscheme}
\begin{scheme}
  \includesvg[schwartz/]{nboc-hydantoin-reduction-zr}
  \caption{
...
\begin{marginscheme}
  \includesvg[schwartz/]{isoxazolidinone-reduction-zr}
  \caption{
...
Niektóre z~prac cytowanych w~sekcji \nameref{literature:schwartz:amides} prezentują też
  zastosowanie opisywanych metodologii do~przekształcenia laktamów.
Zazwyczaj są to pojedyncze, proste przykłady, będące przede wszystkim weryfikacją koncepcji.
W~jednej z~pierwszych doniesień o~redukcji amidów odczynnikiem Schwartza 

% TODO: add hunag15 (rev. Scheme 24) when describing reduction to amines
% TODO: add katahara17 (rev. Scheme 33) lactams part
...
Czerpiąc inspirację z~prac Ganema, wiele uwagi Furman poświęcił 
