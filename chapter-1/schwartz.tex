...
Częściowa redukcja do~formamidu może zostać przeprowadzona dzięki wykorzystaniu łagodniejszego
  \ch{NaBH4}\sidecite{stecko16}, ale metoda ta nie toleruje wielu grup funkcyjnych.

\citeauthor{pace16} zaproponowali podejście oparte o~hydrocyrkonowanie odczynnikiem Schwartza
  generowanym \latin{in situ} za~pomocą \ch{LiAlH(O\tert-Bu)3}\sidecite{pace16}.
Opracowana przez nich procedura jest bardzo wydajna i~w~pełni chemoselektywna.
Pokazali, że otrzymana pochodna formamidu może zostać bezpośrednio aktywowana kolejnym
  ekwiwalentem odczynnika Schwartza i~łatwo poddana dalszej funkcjonalizacji,
  czego wynikiem jest powstanie niesymetrycznej drugorzędowej aminy.
% TODO: add scheme for isocyanides
