...
\begin{marginscheme}
  ...
  \caption{
    Prowadząca do~otrzymania nitronu redukcja amidów z~podstawnikiem \ch{-O-\gls{tbs}}
      na~atomie azotu.
  }
...
Czytelnika zainteresowanego szczegółami odsyłam do~źródła\sidecite[-4\baselineskip]{zheng17}.
...
\citeauthor{dandepally13} zademonstrowali redukcję
  ...
  przeprowadzoną przy użyciu odczynnika Schwartza\sidecite[-7\baselineskip]{dandepally13}.
...
Związek ten jest znany, ale w~warunkach atmosferycznych jest gazem, otrzymywanym przez ogrzanie
  odpowiedniego hemiacetalu \refcmpd{cf3-hemiacetal} nad silnym kwasem albo tlenkiem fosforu,
...
\todo[inline]{%
  Planowałem dodać porówanie reaktywności różnych grup funkcyjnych ze Schwartzem
  na podstawie danych dostępnych w literaturze, podobnie jak w przeglądzie, nad którym
  pracuje Paweł.
  Myślałem, żeby opisać też grupy inne niż amidy, a o których wspominam w przeglądzie,
  może zaprezentować dane na skali, żeby było bardziej wizualnie.
  Zastanawiam się czy na pewno warto to robić - to byłaby wartość dodana w pracy,
  ale w części eksperymentalnej nie poruszam problemu konkurencji w hydrocyrkonowaniu.
  Potrzebuję opinii.
}
