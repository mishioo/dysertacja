...
W~środowisku bezwodnym rozpad wiązania \ch{C-O} w~\refcmpd{mech-zr-4} jest niekorzystny zarówno
...
Ich bezpośrednia funkcjonalizacja poprzedzona generowaniem \latin{in situ} jest rozwiązaniem
...
Jako sposób na~ominięcie tych przeszkód autorzy zaproponowali wykorzystanie amidów Weinreba
  ...
  a~stosunkowo łatwo można przeprowadzić rozszczepienie wiązania \ch{N-OMe},
  otrzymując amidy drugorzędowe.
