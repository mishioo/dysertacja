...
Znajdują się tam również, w~katalogu \enquote{supplementary}, materiały dodatkowe \---
  pliki \text{.cif} otrzymane w~wyniku analizy rentgenostrukturalnej oraz specyfikacja struktur
...
Drugą są reakcje wieloskładnikowe laktamów na~przykładzie jednego z~wariantów reakcji Ugiego.
