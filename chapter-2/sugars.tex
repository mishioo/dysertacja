...
\begin{scheme}
  ...
  \caption{
    ...
    Cykloaddycja do~zwiąku \refcmpd{glu-cp-condensed} następuje pod nieobecność innych czynników
...
Obecność produktu \refcmpd{glu-cp-condensed} w~reakcji bez żadnego nukleofila, mogącego zastąpić
