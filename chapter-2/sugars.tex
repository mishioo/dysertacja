...
\todo[inline]{Opis optymalizacji ilości \ch{TMSN3} i \ch{RNC}.}
\begin{marginfigure}
  \begin{tikzpicture}
    \begin{axis}[
      ...
      ytick={0,50,100},
      extra y ticks={84},
      extra y tick labels={\textcolor{wongvermillion}{$84$}},
      axis lines=left,
      axis line style={-},
  ...
  \addplot[dashed,color=wongvermillion,no markers]
      coordinates {(0.8,84)(2.4,84)};
    \addlegendentry{Średnia wydajność}
