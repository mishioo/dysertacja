...
Związek~\refcmpd{glu-cp-condensed} powstał w~niewielkiej ilości w~tej reakcji,
  głównym produktem był produkt reduktywnej nukleofilowej addycji cyklopentadienu do~iminy,
  oznaczony na~\cref{sch:cp-nucleophile} numerem~\refcmpd{glu-cp}.
Sugeruje to, że obecność indolu nie jest potrzebna do~powstawania
  związku~\refcmpd{glu-cp-condensed}.
