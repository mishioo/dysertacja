...
Dwie pierwsze są strukturami aromatycznymi \--- para elektronowa atomu azotu jest
  ...
  występują w~roztworach w~równowadze zbliżonej do~równomolowej\sidecite{kiselev11}.
\iupac{5\H-Tetrazol} jest natomiast niearomatyczny, a~tym samym mniej trwały,
...
Zaproponował go \citeauthor{friedman50} w~\citeyear{friedman50}\sidecite{friedman50}
  ...
  czyli podobieństwa fizykochemicznego, zwłaszcza małych cząsteczek\sidenote{%
...
Dziś koncept ten zdaje się być nieco zapomniany, a~obydwa pojęcia bywają \---
  czasem niepoprawnie \--- używane zamiennie.
...
Zamiana \ch{F} na~\ch{H} w~strukturze powoduje zazwyczaj wzrost lipofilowości
...
\begin{figure}
  ...
  \caption{
    Pierścień \iupac{\N\H-tetrazolowy} jest bioizosterem kwasu karboksylowego,
      a~\iupac{1-podstawiony} tetrazol \--- amidu.
    W~obu przypadkach uważa się je też za~bioizostery podobnych związków, w~których \ch{R}
      (lub \ch{R^1}) jest oddalone od~karbonylu przez \ch{X} \--- atom lub grupę atomów.
  }
\end{figure}
Ugrupowanie tetrazolowe uważa się za~bioizoster kwasu karboksylowego oraz amidu w~przypadku
  odpowiednio \iupac{\N\H-} i~\iupac{1-podstawionego} tetrazolu.
  
Należy przy tym jednak pamiętać, że podobieństwo fizyczne czy elektronowe ani nie jest
  konieczne do, ani nie implikuje występowania bioizosteryzmu.
% TODO: bioisostere example
% TODO: tetrazole as bioizostere of -COOH and amide
% TODO: tetrazole increases bioacessibility
% TODO: methods of synthesis

\section{Wieloskładnikowe reakcje typu reakcji Ugiego}