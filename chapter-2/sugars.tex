...
Jedną z~nich, najpowszechniej stosowaną, jest wariant reakcji Ugiego, w~którym kwas
  karboksylowy zastąpiony jest azydkiem\sidenote{%
    Wariant ten nazywany jest reakcją azydo-Ugiego (ang. \textit{Ugi-Azide Reaction})
      lub akronimem \gls{azido-ugi}.
  }.
Została ona zaproponowana przez Ugiego i~Steinbr{\"u}cknera w~\citeyear{ugi61} roku\sidecite{ugi61},
  niedługo po~ukazaniu się ich pierwszej pracy poświęconej reakcjom izonitryli,
  w~której opisali oryginalną wersję czteroskładnikowej reakcji Ugiego.
