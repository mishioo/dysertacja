...
\begin{margintable}
  ...
  \begin{tabular}{ r c c }
    ...
    \midrule
    \rownumber & {\includesvg{allylbutylstanne-small}} & \num{30.7} (\refcmpd{b-aminoester-cycloprop.allyl}) \\
...
\begin{table}
  % TODO: format it, maybe with package array or tabularray
  % TODO: add yields
  % TODO: maybe add other structures
  \begin{tabular}{ c c c c }
    \toprule
    Substrat & \multicolumn{3}{c}{Zastosowana procedura aktywacji} \\
             & Schwartz & Vaska & van der Eck \\
    \midrule
    \refcmpd{amidoester-bn} & \SI{42}{\percent} (\refcmpd{amido-cyclo-hemiacetal}) & rozkład & {\includesvg{amidoester-si}} \\
    \refcmpd{amidoester-cyclo} & \SI{15}{\percent} (\refcmpd{amido-cyclo-hemiacetal}) & {\includesvg{amidoester-opened}} & rozkład \\
    \bottomrule
  \end{tabular}
  \caption{
