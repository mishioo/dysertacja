...
\begin{table}
  ...
  \caption{
    ...
    \enquote{Schwartz}, \enquote{Vaska} oraz \enquote{van der Ent} w~nagłówku reprezentują
      metody wykorzystujące odpowiadające kompleksy.
    Szczegółowe procedury znajdują się w~\secref{experimental:amidoester-products}.
