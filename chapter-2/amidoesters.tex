...
Zwracam uwagę, że produkt~\refcmpd{aminoester-bn-allyl} jest jednym z~dwóch diastereoizomerów,
  które mogą powstać w~reakcji, jednak zidentyfikowanie go nie było możliwe bez porównania
  z~drugim diastereoizomerem.
Analiza \NMR*{} mieszaniny poreakcyjnej sugeruje, że on również powstaje w~tej reakcji,
  ale w~ilościach tak małych, że nie udało się go wydzielić.
