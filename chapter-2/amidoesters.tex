...
W~przypadku wielu tego typu związków forma enolowa jest stabilna \---
  na~przykład dimedon\sidenote{Czyli \iupac{5,5-dimetylocykloheksan-1,3-dion}.},
  w~roztworze \ch{CDCl3} przyjmuje formy kotonową i~enolową w~proporcji 2~do~1.
...
W~tej formie chętnie wstępują w~reakcje z~elektrofilami, pozwalając na~łatwą funkcjonalizację
  w~pozycji 2.
% add something about tautomerism?
