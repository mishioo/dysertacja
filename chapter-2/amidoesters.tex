...
\begin{table}
  ...
  \begin{tabular}{ 
    ...
    \midrule
    \refcmpd{amidoester-bn} & \refcmpd{aminoester-bn-allyl}, \SI{22}{\percent} & rozkład & rozkład & b/d \\\addlinespace
    \refcmpd{amidoester-cyclo} & \refcmpd{amido-cyclo-hemiacetal}, \SI{15}{\percent} & {\includesvg{amidoester-opened}} & rozkład & b/d \\
    \bottomrule
  \end{tabular}
  \caption{
