...
W~modelu Woerpla\sidecite{woerpel99} kierunek addycji nukleofila do~cyklicznego kationu
  oksokarbeniowego zależny jest nie od~bezpośredniego otoczenia centrum reakcyjnego,
...
Ze~względu na~płaską geometrię wiązania \ch{-C=O^+\bond{single}}, sześcioczłonowy cykliczny
  kation oksokarbeniowy będzie znajdował się zawsze w~konformacji pół-krzesełkowej
...
\begin{scheme}
  \includesvg{woerpel}
  \caption{
    Kierunek addycji nukleofila do~kationu oksokarbeniowego według modelu Woerpla zależny jest
...
\citeauthor{woerpel00} zaproponowali również taki model dla pierścieni
  pięcioczłonowych\sidecite{woerpel00}, nie będę go tu jednak omawiał.
Warto natomiast wspomnieć, że rozstrzygnięcie, który z~konformerów cyklicznego kationu
  oksoniowego będzie trwalszy, może nie być trywialne ze~względu na~występowanie
