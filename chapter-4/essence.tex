...
\begin{table*}
  ...
  \begin{tabular}{ r *{6}{c} }
    ...
    Wizualizacja cząsteczki    & \markno & \markok & \markok & \markno & \markok & \markno \\
  \end{tabular}
  \caption{
...
\Cref{tac:comparison} zawiera porównanie tych programów pod kątem funkcjonalności, jakie oferują.
