...
W~czasie pisania niniejszej dysertacji jest on najbardziej popularnym językiem programowania
  według indeksu TIOBE\sidecite{tiobe}, sprawdzającego na~ilu stronach internetowych dany język
  programowania jest wspominany, jak i~indeksu \gls{pypl}]\sidecite{pypl}, mierzącego ilość
  wyszukiwań tutoriali dla danego języka.
