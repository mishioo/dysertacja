...
Ochota z~jaką programiści sięgają po to narzędzie wynika też z~jego dużej przystępności,
  łatwości pracy z~nim i~zaangażowanej społeczności programistów Pythona.
...
Istnienie dodatków takich jak NumPy\sidecite{numpy} \--- paczka służąca do~wydajnego prowadzenia
  obliczeń na~macierzach \--- pozwala przekroczyć część jego ograniczeń, wynikających z~jego
...
Stąd też Python został szeroko zaadaptowany w~nauce \--- zwłaszcza w~naukach o~danych i~uczeniu
  maszynowym.
