...
Zacznie szukać tych innych treści dopiero gdy napotka frazę, która będzie dla niego
  sygnałem do~zmiany stanu \--- w~przykładowej sytuacji byłaby to pusta linia po~koordynatach
  ostatniego z~atomów.
