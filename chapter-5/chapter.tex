...
W kolbie umieściłem \SI{17.25}{\gram} \ch{K2CO3}, \SI{25}{\milli\liter} \ch{PhMe},
  \SI{0.25}{\milli\liter} \ch{H2O}, \SI{0.2}{\gram} \ch{Bn4N+ Br-}, \SI{5.8}{\milli\liter}
  malonianu dimetylu oraz \SI{8.7}{\milli\liter} \iupac{1,2-dibromoetanu}.
...
Dodałem do~mieszaniny jeszcze \SI{9}{\gram} \ch{K2CO3}, \SI{25}{\milli\liter} \ch{PhMe},
  \SI{2}{\milli\liter} \ch{H2O}, \SI{0.1}{\gram} \ch{Bn4N+ Br-} oraz \SI{4.5}{\milli\liter}
...
Do \SI{3}{\gram} związku \refcmpd{cyclopropyl-dimethyl-malonate} dodałem \SI{1066}{\milli\gram}
  \ch{KOH} rozpuszczonego w~\SI{15}{\milli\liter} bezwodnego \ch{MeOH} w~atmosferze argonu.
Mieszałem we~wrzeniu przez \SI{2}{\hour}, po~czym usunąłem rozpuszczalnik
  przy użyciu wyparki rotacyjnej.
Otrzymany osad rozpuściłem w~\SI{10}{\milli\liter} \ch{H2O}, zakwasiłem do~\pH$=7$ za~pomocą
  \SI{10}{\percent} \ch{HCl_{aq}}, nasyciłem \ch{NaCl} i~ekstrahowałem
  \SI[product-units = single]{4 x 10}{\milli\liter} \ch{Et2O}.
...
Nieoczyszczony związek \refcmpd{cyclopropyl-monomethyl-malonate} rozpuściłem w~\SI{40}{\milli\liter}
...
W~atmosferze argonu rozpuściłem surową mieszaninę poreakcyjną zawierającą związek
  \refcmpd{cyclopropyl-methyl-malonate-chloride} w~\SI{20}{\milli\liter} acetonu.
Dodałem \SI{1550}{\milli\gram} \iupac{p-anizydyny} oraz \SI{1.75}{\milli\liter} \ch{Et3N}.
