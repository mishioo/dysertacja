...
\begin{fullwidth}
\subsection{%
  \refcmpd{b-aminoester-cycloprop.allyl}:
  \iupac{1-(1-[(4-metoksyfenylo)amino)but-3-en-1-ylo]cyklopropanokarboksylan metylu}%
}\label{syn:b-aminoester-cycloprop.allyl}
\end{fullwidth}
\marginnote{\includesvg{b-aminoester-cycloprop.allyl}}
