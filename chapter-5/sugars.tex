...
The compound was synthesized by the following procedure:
\SI{10}{\milli\gram} (\SI{0.016}{\milli\mol}) of compound \refcmpd{glu-tet-cyklo-lactam} was dissolved in \SI{0.3}{\milli\liter} of dry \ch{THF} and added to \SI{6.6}{\milli\gram} (\SI{0.026}{\milli\mol}, \SI{1.6}{\equiv}) of \ch{Cp2Zr(H)Cl}.
