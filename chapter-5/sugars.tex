...
\begin{figure*}
	...
	\caption{
		...
		Kolorem zaznaczyłem ulegające przemianie fragmenty struktur,
			aby ułatwić śledzenie przemian następujących w~każdym etapie.
...
Laktamy wywiedzione z~cukrów prostych: glukozy~(laktam \cmpd{glu-lactam})
	oraz galaktozy~(laktam \cmpd{gal-lactam}), użyte jako substraty do~badań przeprowadzonych
	w~niniejszej dysertacji, zostały przygotowane zgodnie z~procedurą opisaną
	w~literaturze\sidecite{furman14}.
