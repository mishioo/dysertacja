...
\SI{0.36}{\mmol} odczynnika Schwartza\sidenote[][-6\baselineskip]{%
...
} oraz \SI{0.2}{\mmol} laktamu\sidenote{
  W~przypadku laktamu będącego olejem dodawałem jego osobno przygotowany roztwór
    do~zawiesiny odczynnika Schwartza.
} i~dodałem \SI{4.0}{\mL} suchego \gls{thf}.
...
\begin{fullexp}
	\data*{yield} \SI{73}{\percent} (white needles)\par\noindent
	\data{mp.} \numrange{166}{167}\si{\celsius}\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{27.3} ($c = 2.10$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{37}{\percent} (white solid)\par\noindent
	\data{mp.} \numrange{153}{154}\si{\celsius}\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{21.5} ($c = 1.00$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{49}{\percent} (white solid)\par\noindent
	\data{mp.} \numrange{94}{95}\si{\celsius}\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{23.0} ($c = 1.00$, \ch{DCM})\par\noindent
...
It was purified using \SI{25}{\percent} \ch{AcOEt} in hexanes as eluent.
\begin{fullexp}
	\data*{yield} \SI{6}{\percent} (yellow waxy oil)\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{8.7} ($c = 0.27$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{42}{\percent} (white needles)\par\noindent
	\data{mp.} \numrange{139}{142}\si{\celsius}\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{22.1} ($c = 1.00$, \ch{DCM})\par\noindent
...
It was purified using \ch{AcOEt} in hexanes in \SI{10}{\percent} to \SI{40}{\percent} gradient as eluent.
\begin{fullexp}
	\data*{yield} \SI{40}{\percent} (white solid)\par\noindent
	\data{mp.} \numrange{164}{165}\si{\celsius}\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{37.1} ($c = 0.54$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{48}{\percent} (yellow oil)\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{24.2} ($c = 0.83$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{33}{\percent} (white solid)\par\noindent
	\data{mp.} \numrange{158}{159}\si{\celsius}\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{33.4} ($c = 1.01$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{3}{\percent} (white waxy oil)\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{21.8} ($c = 0.17$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{95}{\percent} (colourless oil)\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{49.6} ($c = 0.87$, \ch{DCM})\par\noindent
...
\begin{fullexp}
	\data*{yield} \SI{75}{\percent} (light grey solid)\par\noindent
	\data{mp.} \numrange{180}{183}\si{\celsius}\par\noindent
	\data{[$\alpha^{23}_D$]~$=$} \num{57.2} ($c = 0.60$, \ch{DCM})\par\noindent
