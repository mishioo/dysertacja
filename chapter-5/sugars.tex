...
\procedure{epi-glu-tet.cy}{\iupac{\cip{2S,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-cyclohexyl-1\H-tetrazol-5-yl)piperidine}}  % MMW-221-B 
...
\procedure{epi-glu-tet.pmp}{\iupac{\cip{2S,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-(4-methoxyphenyl)-1\H-tetrazol-5-yl)piperidine}}  % MMW-303-A 
The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu-tet}) using \SI{26.8}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{benzyl isocyanide}.
It was purified using \SI{25}{\percent} \ch{AcOEt} in hexanes as eluent.
\begin{fullexp}
...
\procedure{epi-gal-tet.cy}{\iupac{\cip{2R,3S,4R,5S,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-cyclohexyl-1\H-tetrazol-5-yl)piperidine}}  % MMW-457-3 
