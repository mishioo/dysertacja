\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-cyclohexyl-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet.cy})  % MMW-221-A; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{26.7}{\micro\liter} (\SI{0.22}{\milli\mol}) of cyclohexyl isocyanide.
	It was purified using \ch{AcOEt} in hexanes in \SI{25}{\percent} to \SI{40}{\percent} gradient as eluent and exceptionally using Florisil\textsuperscript{\textregistered} as stationary phase.
	It was recrystallized from diethyl ether/hexanes mixture for X-ray analysis.
	\data*{yield} \SI{73}{\percent} (white needles); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C41H47N5O4Na}: \num{696.3526} found: \num{696.3503}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2S,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-cyclohexyl-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{epi:glu:tet.cy})  % MMW-221-B; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}),
	but with addition of \SI{0.5}{\micro\liter} of dry \ch{MeOH} before addition of \SI{26.7}{\micro\liter} (\SI{0.22}{\milli\mol}) of cyclohexyl isocyanide.
	It was purified using \ch{AcOEt} in hexanes in \SI{30}{\percent} to \SI{40}{\percent} gradient as eluent.
	\data*{yield} \SI{37}{\percent} (white solid); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C41H48N5O4}: \num{674.3706} found: \num{674.3685}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{Ethyl (5-(\cip{2R,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)piperidin-2-yl)-1\H-tetrazol-1-yl)acetate}} (\refcmpd{glu:tet.est})  % MMW-289-B; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{24.0}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{ethyl isocyanoacetate}.
	It was purified using \ch{AcOEt} in \ch{DCM} in \SI{3}{\percent} to \SI{7}{\percent} gradient as eluent.
	\data*{yield} \SI{49}{\percent} (white solid); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C39H43N5O6}: \num{678.3292} found: \num{678.3286}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5R,6R}- 3,4,5-tris(benzyloxy)-6-[(benzyloxy)methyl]-2-(1-benzyl-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet.benz})  % MMW-281; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{26.8}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{benzyl isocyanide}.
	It was purified using \ch{AcOEt} in hexanes in \SI{10}{\percent} to \SI{40}{\percent} gradient as eluent.
	\data*{yield} \SI{18}{\percent} (white solid); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C42H44N5O4}: \num{682.3393} found: \num{682.3383}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-(4-methoxyphenyl)-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet.pmp})  % MMW-303-C; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{26.8}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{benzyl isocyanide}.
	It was purified using \SI{25}{\percent} \ch{AcOEt} in hexanes as eluent.
	\data*{yield} \SI{23}{\percent} (white solid); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C42H44N5O5}: \num{698.3342} found: \num{698.3341}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2S,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-(4-methoxyphenyl)-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{epi:glu:tet.pmp})  % MMW-303-A; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{26.8}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{benzyl isocyanide}.
	It was purified using \SI{25}{\percent} \ch{AcOEt} in hexanes as eluent.
	\data*{yield} \SI{6}{\percent} (yellow waxy oil); 
...
\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3R,4R,5S,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-(4-methoxybenzyl)-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet.pmb})  % MMW-408; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{32.4}{\milli\gram} (\SI{0.22}{\milli\mol}) of \iupac{4-methoxybenzyl} isocyanide dissolved in \SI{0.5}{\milli\liter} of dry \ch{THF}.
	It was purified using \iupac{\tert-butyl methyl ether} in \ch{DCM} in \SI{0}{\percent} to \SI{3}{\percent} gradient as eluent.
	\data*{yield} \SI{42}{\percent} (white needles); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C43H46N5O5}: \num{712.3499} found: \num{712.3484}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3R,4R,5S,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-(\tert-butyl)-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet.tbu})  % MMW-280; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{22.6}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{\tert-butyl isocyanide}.
	The reaction was stirred for \SI{12}{\day}.
	It was purified using \ch{AcOEt} in hexanes in \SI{10}{\percent} to \SI{40}{\percent} gradient as eluent.
	\data*{yield} \SI{40}{\percent} (white solid); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C39H46N5O4}: \num{648.3550} found: \num{648.3542}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-(\tert-octyl)-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet.oct})  % MMW-439-C; 
	\par\noindent
	The compound was synthesized according to the general procedure for glucose-derived $\alpha$-tetrazoloamines (\refcmpd{glu:tet}) using \SI{40.9}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{\tert-octyl} isocyanide.
	The reaction was stirred for \SI{3}{\day}.
	It was purified using \SI{20}{\percent} \ch{AcOEt} in hexanes as eluent.
	\data*{yield} \SI{48}{\percent} (yellow oil); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C41H55N5O4Na}: \num{704.4152} found: \num{704.4152}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5S,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-cyclohexyl-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{gal:tet.cy})  % MMW-292; 
	\par\noindent
	The compound was synthesized according to the general procedure for galactose-derived $\alpha$-tetrazoloamines (\refcmpd{gal:tet}) using \SI{26.7}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{cyclohexyl isocyanide}.
	It was purified using a 2:28:70 mixture of \ch{Et3N}/\ch{AcOEt}/hexanes as eluent.
	\data*{yield} \SI{33}{\percent} (white solid); 
...
\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5S,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1-cyclohexyl-1\H-tetrazol-5-yl)piperidine}} (\refcmpd{epi:gal:tet.cy})  % MMW-457-3; 
	\par\noindent
	The compound was synthesized according to the general procedure for galactose-derived $\alpha$-tetrazoloamines (\refcmpd{gal:tet}),
	but with addition of \SI{0.5}{\micro\liter} of dry \ch{MeOH} before addition of \SI{26.7}{\micro\liter} (\SI{0.22}{\milli\mol}) of cyclohexyl isocyanide.
	It was purified by preparative HPLC using \SI{10}{\percent}  acetone in toluene as eluent.
	\data*{yield} \SI{3}{\percent} (white waxy oil); 
...
\begin{experimental}
	\noindent\textbf{\iupac{Ethyl (5-(\cip{2R,3S,4R,5S,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)piperidin-2-yl)-1\H-tetrazol-1-yl)acetate}} (\refcmpd{gal:tet.est})  % MMW-293-B; 
	\par\noindent
	The compound was synthesized according to the general procedure for galactose-derived $\alpha$-tetrazoloamines (\refcmpd{gal:tet}) using \SI{26.7}{\micro\liter} (\SI{0.22}{\milli\mol}) of \iupac{cyclohexyl isocyanide}.
	It was purified using \SI{30}{\percent} \ch{AcOEt} in cyclohexane as eluent.
	\data*{yield} \SI{16}{\percent} (white solid); 
...
\begin{experimental}
	\noindent\textbf{\iupac{\cip{8R,9R,10R,11S,11aR}-9,10,11-tris(benzyloxy)-8-((benzyloxy)methyl)-9,10,11,11a-tetrahydro-8\H-pyrido[1,6-a]tetrazolo[5,1-c]pyrazin-6(5\H)-one}} (\refcmpd{glu:tet:cyclo:lactam})  % MMW-382 (i MMW-388); 
	\par\noindent
	...
	\data*{yield} \SI{95}{\percent} (light yellow waxy oil); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C37H37N5O5Na}: \num{654.2692} found: \num{654.2670}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{8R,9S,10R,11S,11aR}-9,10,11-tris(benzyloxy)-8-((benzyloxy)methyl)-5,6,9,10,11,11a-hexahydro-8\H-pyrido[1,6-a]tetrazolo[5,1-c]pyrazine}} (\refcmpd{glu:tet:cyclo})  % MMW-427; 
	\par\noindent
	The compound was synthesized by the following procedure:
	...
	\data*{yield} \SI{75}{\percent} (yellow oil); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C37H39N5O4Na}: \num{640.2900} found: \num{640.2892}
\end{experimental}

\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(2-(4-methoxyphenyl)-2\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet:pmb:rearr})  % MMW-411; 
	\par\noindent
	The compound was synthesized by the following procedure:
	...
	\data*{yield} \SI{95}{\percent} (colourless oil); 
...
\begin{experimental}
	\noindent\textbf{\iupac{\cip{2R,3S,4R,5R,6R}-3,4,5-tris(benzyloxy)-6-((benzyloxy)methyl)-2-(1\H-tetrazol-5-yl)piperidine}} (\refcmpd{glu:tet:free})  % MMW-448; 
	\par\noindent
	The compound was synthesized by the following procedure:
	...
	\data*{yield} \SI{75}{\percent} (light grey solid); 
	...
	\data{HRMS} (ESI-TOF) m/z calcd for \ch{C35H38N5O4}: \num{592.2924} found: \num{592.2925}
\end{experimental}
