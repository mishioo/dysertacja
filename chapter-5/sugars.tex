...
\SI{10.0}{\gram} perbenzylowanej glukozy rozpuściłem w~\SI{50}{\mL} \gls{dmso}
	i~dodałem \SI{30}{\mL} \ch{Ac2O} i~mieszałem przez noc w~temperaturze pokojowej.
Po tym czasie dodałem~\SI{200}{\mL} \ch{H2O} i~mieszałem intensywnie przez \SI{15}{\minute},
...
Tak otrzymany surowy związek \refcmpd{glu-lacton} rozpuściłem w~\SI{40}{\mL} \ch{MeOH},
...
Następnie rozpuściłem go w~\SI{40}{\mL} \gls{dmso} i~dodałem \SI{25}{\mL} \ch{Ac2O}
	i~mieszałem przez noc w~temperaturze pokojowej.
Do~mieszaniny dodałem~\SI{200}{\mL} \ch{H2O} i~mieszałem intensywnie przez \SI{15}{\minute}.
...
Otrzymany w~ten sposób surowy związek \refcmpd{glu-amide-on} rozpuściłem w~\SI{300}{\mL}
	przygotowanego wcześniej \SI{8}{\Molar} roztworu amoniaku w~\ch{MeOH},
	mieszałem przez \SI{2}{\hour}, po~czym pozwoliłem by \ch{NH3} odparował przez noc.
Pozostały rozpuszczalnik usunąłem przy użyciu wyparki rotacyjnej.
\todo[inline]{ostatni etap i analizy}

\procedure{gal-lactam}{\iupac{\cip{3R,4S,5S,6R}-3,4,5-tris(benzyloksy)-6-((benzyloksy)metylo)-piperydyn-2-on}}
\todo[inline]{synteza jak powyżej i analizy}
...
\procedure{gal-tet.cy}{\iupac{\cip{2R,3S,4R,5S,6R}-3,4,5-tris(benzyloksy)-6-((benzyloksy)metylo)-2-(1-cykloheksylo-1\H-tetrazol-5-ylo)piperydyna}}  % MMW-292 
Otrzymałem zgodnie z~\hyperref[experimental:sugars:schwartz]{procedurą syntezy tetrazolowych
...
\procedure{gal-tet.est}{\iupac{(5-(\cip{2R,3S,4R,5S,6R}-3,4,5-tris(benzyloksy)-6-((benzyloksy)metylo)piperydyn-2-ylo)-1\H-tetrazol-1-yl)octan etylu}}  % MMW-293-B 
Otrzymałem zgodnie z~\hyperref[experimental:sugars:schwartz]{procedurą syntezy tetrazolowych
	pochodnych iminocukrów}, wychodząc z~wywiedzionego z~galaktozy laktamu~\refcmpd{gal-lactam}
	i~używając \SI{24.0}{\micro\liter} (\SI{0.22}{\milli\mol}) izocyjanooctanu etylu.
Oczyszczałem chromatograficznie na~żelu krzemionkowym,
...
Oczyszczałem chromatograficznie na~żelu krzemionkowym, jako eluentu używając eteru
	\iupac{\tert-butylowo-metylowego} w~\ch{DCM} w~gradiencie \SIrange{10}{40}{\percent}.
...
Po tym czasie odparowałem rozpuszczalnik przy użyciu wyparki rotacyjnej,
	rozpuściłem pozostałość w~\SI{20}{\milli\liter} \ch{DCM},
...
Oczyszczałem chromatograficznie na~żelu krzemionkowym w~eluencie \SI{5}{\percent} \ch{AcOEt} w~\ch{DCM}.
...
Oczyszczałem chromatograficznie na~żelu krzemionkowym, jako eluentu używając mieszaniny
	\ch{NH3_{(aq)}}/\ch{MeOH}/\ch{DCM} w~gradiencie proporcji $0:10:90$ do~$1:20:80$.
...
Komplet danych dostępny jest w~bazie krystalograficznej Cambrigde\sidenote{%
	...
	}, na~dołączonej do~dysertacji płycie CD oraz w~repozytorium z~kodem źródłowym tej
	pracy w~katalogu \enquote{supplementary}\sidenote{\url{github.com/mishioo/dysertacja}}.
