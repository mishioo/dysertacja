...
Otrzymany osad rozpuściłem w~\SI{10}{\mL} \ch{H2O}, doprowadziłem do~$\pH{}=7$ za~pomocą
...
Nieoczyszczony związek \refcmpd{cyclopropyl-monomethyl-malonate} rozpuściłem w~\SI{40}{\mL}
  bezwodnego \ch{CH2Cl2} w~atmosferze argonu. Dodałem \SI{2.2}{\mL} chlorku oksalilu
  i~\num{3} krople \gls{dmf}.
...
\begin{fullexp}
  ...
  \data{HRMS}[ESI-TOF] m/z obliczone dla \ch{C13H15NO4Na}: \num{272.0899} zarejestrowane: \num{272.0902}
\end{fullexp}
...
Po~tym czasie odsączyłem sole nieorganiczne na~celicie i~odparowałem rozpuszczalnik za~pomocą
  wyparki rotacyjnej.
Oczyszczałem za~pomocą chromatografii \textit{flash} używając jako eluentu octanu etylu w~heksanie
...
\begin{fullexp}
  ...
  \data{HRMS}[ESI-TOF] m/z obliczone dla \ch{C19H21NO4Na}: \num{350.1372} zarejestrowane: \num{350.1372}
\end{fullexp}
...
\begin{fullexp}
  ...
  \data{HRMS}[ESI-TOF] m/z obliczone dla \ch{C14H19NO4Na}: \num{288.1212} zarejestrowane: \num{288.1216}
\end{fullexp}
  
\procedure{amidoester-cyclo}{\iupac{2-okso-\N-fenylotetrahydrofuran-3-karboksyamid}}
  \marginnote{Analiza \NMR*{} zgodna z~literaturą.}
Związek ten był dostępny na~stanie zespołu badawczego w~którym realizowana była niniejsza dysertacja.
Analiza \NMR* oraz \NMR*{13,C}, zgodna z~danymi dostępnymi w~literaturze,
  jednoznacznie potwierdza jego strukturę.

\begin{fullexp}
  \NMR(400)[CDCl3] \num{8.91} (s, \#{1}), \numrange{7.57}{7.51} (m, \#{2}), \numrange{7.36}{7.29} (m, \#{2}), \numrange{7.16}{7.10} (m, \#{1}), \num{4.47} (td, \J{8.9;4.1}, \#{1}), \num{4.35} (td, \J{8.8;7.4}, \#{1}), \num{3.60} (t, \J{9.5}, \#{1}), \num{2.81} (dq, \J{13.3;8.8}, \#{1}), \num{2.59} (dddd, \J{13.6;9.7;7.5;4.1}, \#{1}); 
...
W~przepływie argonu dodałem \SI{249}{\mg} \ch{Yb(OTf)3} oraz \SI{186}{\uL} allilotributylocyny.
...
\begin{fullexp}
  ...
  \data{HRMS}[ESI-TOF] m/z obliczone dla \ch{C16H22NO3}: \num{276.1600} zarejestrowane: \num{276.1597};
...
\begin{fullexp}
  ...
  \data{HRMS}[ESI-TOF] m/z obliczone dla \ch{C14H17N2O3}: \num{261.1239} zarejestrowane: \num{261.1241}
\end{fullexp}
...
\begin{fullexp}
  ...
  \data{HRMS}[ESI-TOF] m/z obliczone dla \ch{C15H22NO3}: \num{264.1600} zarejestrowane: \num{264.1601}
\end{fullexp}
...
\begin{fullexp}
  ...
  \data{HRMS}[ESI-TOF] m/z obliczone dla \ch{C22H28NO3}: \num{354.2069} zarejestrowane: \num{354.2070}
\end{fullexp}
