...
Do wygrzanego w~płomieniu palnika i~wypełnionego gazem obojętnym naczynia Schlenka odważyłem
  ...
  dodałem \SI{10}{\milli\gram} (\SI{0.016}{\milli\mol}) związku~\refcmpd{glu-tet-cyclo-lactam}
...
Komplet danych dostępny jest w~bazie krystalograficznej Cambrigde\sidenote{%
  ...
  }, w~dołączonych do~dysertacji materiałach elektronicznych oraz w~repozytorium\sidenote{\repourl}
